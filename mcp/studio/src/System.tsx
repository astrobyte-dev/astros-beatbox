...
export function System() {
  ...
  return <div className="system-page">
    ...
    <main id="system-main" className="system-main">
      ...
      <footer className="system-footer">Astro’s Beatbox · local runtime{snapshot && <details><summary>Runtime identity</summary><code>{snapshot.sessionId} · generation {snapshot.generation}</code><p>Last health transition: {time(snapshot.transitionedAt)}</p></details>}</footer>
    </main>
