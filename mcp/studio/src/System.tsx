...
export function System() {
  ...
  return <div className="system-page">
    ...
    <main id="system-main" className="system-main">
      ...
      <section className="system-card system-compatibility"><details><summary>Compatibility tools · classic dashboard</summary><p>The classic dashboard still provides output-device selection, Tidal source import/export, raw code and legacy routing. These tools can change playback outside your Studio project.</p><a href="/" target="_blank" rel="noreferrer">Open classic dashboard ↗</a></details></section>
